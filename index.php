...
<div class="container">
    <header class="header">
        ...
        <p>By <a href="https://github.com/AugustineMusine254">Augustine Musine</a></p>
    </header>
    <div class="wrapper">
        <div class="form">
            <form method="POST">
                <label for="userName">Full Name</label>
                <input type="text" name="u_name" id="userName" placeholder="Enter FullNames" autocomplete="off" required>
                <label for="userEmail">Email</label>
                <input type="email" name="u_email" id="userEmail" placeholder="Enter Email Address" autocomplete="off" required>
